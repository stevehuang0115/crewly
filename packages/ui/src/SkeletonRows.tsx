  ...
  return (
    <div className="animate-pulse space-y-3" data-testid="skeleton-rows">
      {Array.from({ length: count }, (_, i) => (
        <div key={i} className="bg-surface-dark border border-border-dark rounded-2xl p-5 space-y-3">
          <div className="h-4 bg-background-dark/50 rounded-[0.5rem] w-3/4" />
          <div className="h-3 bg-background-dark/50 rounded-[0.5rem] w-1/2" />
